 ...
 * generated in the bai2wsclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GreatestNumberResponse_QNAME = new QName("http://medianews.vn/", "greatestNumberResponse");
    private final static QName _GetNumberResponse_QNAME = new QName("http://medianews.vn/", "getNumberResponse");
    private final static QName _GreatestNumber_QNAME = new QName("http://medianews.vn/", "greatestNumber");
    private final static QName _GetNumber_QNAME = new QName("http://medianews.vn/", "getNumber");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bai2wsclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://medianews.vn/", name = "greatestNumberResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://medianews.vn/", name = "getNumberResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://medianews.vn/", name = "greatestNumber")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://medianews.vn/", name = "getNumber")
